...
//Constructors / Destructors
  CPdhCounter(LPCTSTR pszFullCounterPath=NULL, DWORD dwUserData = 0);
...
//Methods
  ...
  void  SetFullCounterPath(LPCTSTR pszFullCounterPath);
...
public:
//Static Methods
  static BOOL ValidatePath(LPCTSTR pszFullCounterPath);
