...
protected:	// ScintillaBase subclass needs access to much of Editor
  ...
  CKeyQueue m_KeyQueue;
	...
	virtual unsigned int NotifyParent(SCNotification scn) = 0;
	virtual unsigned int GotoDocuemntEnd( ) = 0;
  ...
  void ReplaceCurrentLine(const char* s, int insertLength);
